...
func resolveParams(cmd *cobra.Command, fileConfig glossariescmd.FileConfig, glossaryUIDOrName, inFile string) (srv.ImportParams, error) {
	...
	cfg := fileConfig.Glossaries.Import
