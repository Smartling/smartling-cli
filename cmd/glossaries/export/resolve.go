...
func resolveParams(cmd *cobra.Command, fileConfig glossariescmd.FileConfig, glossaryUIDOrName, outFile string) (srv.ExportParams, error) {
	...
	cfg := fileConfig.Glossaries.Export
