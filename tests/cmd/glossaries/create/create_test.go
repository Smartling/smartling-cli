...
func TestGlossaryCreate(t *testing.T) {
	...
	subCommands := []string{"glossaries", "create"}
	tests := []struct {
		name              string
		args              []string
		...
		},
		{
			...
			args:              []string{"glossaries", "--output", "table", "create", "test-integration-glossary-create-table", "--locale", "en-US"},
		...
		},
		{
			...
			args:              []string{"glossaries", "--output", "json", "create", "test-integration-glossary-create-json", "--locale", "en-US"},
