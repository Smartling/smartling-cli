...
func TestGlossaryList(t *testing.T) {
	...
	subCommands := []string{"glossary", "list"}
	tests := []struct {
		name              string
		args              []string
		...
		},
		{
			...
			args:              []string{"glossary", "--output", "table", "list"},
		...
		},
		{
			...
			args:              []string{"glossary", "--output", "json", "list", "--name", "test-integration-glossary-create"},
		...
		},
		{
			...
			args:            []string{"glossary", "--output", "invalid", "list"},
