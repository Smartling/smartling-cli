## smartling-cli glossary export

Glossary export process

### Synopsis

Export glossary entries into a file with the selected format.

```
smartling-cli glossary export <glossaryUID|glossaryName> [outFile] [flags]
```
...
* [smartling-cli glossary](smartling-cli_glossary.md)	 - glossary
